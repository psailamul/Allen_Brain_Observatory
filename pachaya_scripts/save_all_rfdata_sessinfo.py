...
def filter_cells_for_rf(
    ...
    for sess in exp_session:
        ...
        if it_session in rf_session:
            cre_line = sess['cre_line']
            imaging_depth =sess['imaging_depth']
            targeted_structure = sess['targeted_structure']
            ...
            for cell_specimen_id, session_filter in tqdm(
                ...
                if session_filter:
                    ...
                    for lsn_deg in sparse_noise_type:
                        ...
                        rf_info['cre_line'] = cre_line
                        rf_info['imaging_depth'] = imaging_depth
                        rf_info['targeted_structure'] = targeted_structure
